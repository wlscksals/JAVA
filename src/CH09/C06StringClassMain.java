...
public class C06StringClassMain {
	...
	public static void main(String[] args) {
		...
		String str3 = str1 + str2; // 반복적으로 문자열을 덧붙일때 메모리공간이 비효율적
		String str4 = str1.concat(str2); // 반복적으로 문자열을 덧붙일때 메모리공간이 비효율적
...
//		System.out.println(tmp.trim().length()); // trim 입력된 값의 앞뒤 공백 제거
